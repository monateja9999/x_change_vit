						...
						<tr>
							<td>
								...
								<select class="btn btnghost btn-lg" name="Block"required="required"style="font-family: Georgia;font-size:20px width=200px">
									...
									<option value="AL" style="font-size: 20px">A BLOCK(L) </option>
									<option value="B" style="font-size: 20px">B BLOCK </option>
									<option value="B(L)" style="font-size: 20px">B BLOCK(L) </option>
									<option value="B(ANNEX)" style="font-size: 20px">B ANNEX </option>
									<option value="C" style="font-size: 20px">C BLOCK </option>
									<option value="C(L)" style="font-size: 20px">C BLOCK(L) </option>
									<option value="D" style="font-size: 20px">D BLOCK </option>
									<option value="D(L)" style="font-size: 20px">D BLOCK(L) </option>
									<option value="D(ANNEX)" style="font-size: 20px">D ANNEX </option>
									<option value="E" style="font-size: 20px">E BLOCK </option>
									<option value="E(L)" style="font-size: 20px">E BLOCK(L) </option>
									<option value="E(ANNEX)(L)" style="font-size: 20px">E ANNEX(L) </option>
									<option value="F" style="font-size: 20px">F BLOCK </option>
									<option value="F(L)" style="font-size: 20px">F BLOCK(L) </option>
