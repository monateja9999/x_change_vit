		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				...
				<div style="margin-left:260px;width:220px">
					...
					<button type="submit" id="submit" value="submit" class=btn btn-primary style="border-radius:6.5px;background-color: grey;color:white">Mess Admin</button><br><br>
					</a>
					<a href=login.php>
					<button type="submit" id="submit" value="submit" class=btn btn-primary style="border-radius:6.5px;background-color: grey;color:white">Student</button><br><br>
					</a>
